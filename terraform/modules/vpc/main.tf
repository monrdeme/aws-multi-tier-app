...
resource "aws_subnet" "private_app" {
  ...
  tags = {
    Name        = "${var.project_name}-${var.env}-private-app-subnet-${count.index + 1}"
    Project     = var.project_name
    Environment = var.env
  }
}
...
resource "aws_subnet" "private_db" {
  ...
  tags = {
    Name        = "${var.project_name}-${var.env}-private-db-subnet-${count.index + 1}"
    Project     = var.project_name
    Environment = var.env
  }
}
...
resource "aws_route_table" "private_app" {
  ...
  tags = {
    Name        = "${var.project_name}-${var.env}-private-app-rt-${count.index + 1}"
    Project     = var.project_name
    Environment = var.env
  }
...
resource "aws_route_table" "private_db" {
  ...
  tags = {
    Name        = "${var.project_name}-${var.env}-private-db-rt-${count.index + 1}"
    Project     = var.project_name
    Environment = var.env
  }
}
